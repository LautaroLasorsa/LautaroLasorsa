...
python  = f"""<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-plain-wordmark.svg" height={alto}/>"""
...
bash    = f"""<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bash/bash-original.svg" height={alto}/>"""
...
sections["University Assigments"] = [
    ("Licenciature Tesis (10/10) <i>Propuesta de mejora del bienestar económico</i>",
     ...
     [python,numpy,pandas,matplotlib,jupyter, cpp,cuda]),
