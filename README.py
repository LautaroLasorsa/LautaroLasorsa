...
polars = f"""<img src="https://go-skill-icons.vercel.app/api/icons?i=polars" height={alto}/>"""
sqlite = f"""<img src="https://go-skill-icons.vercel.app/api/icons?i=sqlite" height={alto}/>"""
docker = f"""<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/docker/docker-original-wordmark.svg" height={alto}/>"""
sections = {}
...
sections["Competitive Programming"] = [
    ...
    ("OIA UNLaM Course material", "https://github.com/LautaroLasorsa/OIA-UNLaM", [cpp]),
    (
...
sections["Other Projects"] = [
    (
    "<i> Features Store Practice </i>",
    "https://github.com/LautaroLasorsa/features_store_practice",
    [python, polars, sqlite, docker]
    )]
